  ...
  m_compositor(compositor)
{
  m_clientXBMCWaylandResource =
    static_cast<struct wl_resource *>(wl_client_add_object(client,
                                                           &xbmc_wayland_interface,
                                                           &m_listener,
                                                           id,
                                                           this));
	m_clientXBMCWaylandResource->destroy = XBMCWayland::UnbindFromClientCallback;
}
...
{
  delete static_cast<XBMCWayland *>(r->data);
}
...
xtw::XBMCWayland::AddModeCallback(struct wl_client *c,
                                  ...
                                  uint32_t f)
{
  static_cast<XBMCWayland *>(r->data)->AddMode(c, r, w, h, re, f);
}
...
xtw::XBMCWayland::MovePointerToOnSurfaceCallback(struct wl_client *c,
                                                 ...
                                                 wl_fixed_t y)
{
  static_cast<XBMCWayland *>(r->data)->MovePointerToOnSurface(c, r, s, x, y);
}
...
xtw::XBMCWayland::SendButtonToSurfaceCallback(struct wl_client *c,
                                              ...
                                              uint32_t st)
{
  static_cast<XBMCWayland *>(r->data)->SendButtonToSurface(c, r, s, b, st);
}
...
xtw::XBMCWayland::SendAxisToSurfaceCallback(struct wl_client *c,
                                            ...
                                            wl_fixed_t v)
{
  static_cast<XBMCWayland *>(r->data)->SendAxisToSurface(c, r, s, b, v);
}
...
xtw::XBMCWayland::SendModifiersToKeyboardCallback(struct wl_client *c,
                                                  ...
                                                  uint32_t g)
{
  static_cast<XBMCWayland *>(r->data)->SendModifiersToKeyboard(c, r, s, d, la, lo, g);
}
...
xtw::XBMCWayland::SendKeyToKeyboardCallback(struct wl_client *c,
                                            ...
                                            uint32_t st)
{
  static_cast<XBMCWayland *>(r->data)->SendKeyToKeyboard(c, r, s, k, st);
}
...
xtw::XBMCWayland::GiveSurfaceKeyboardFocusCallback(struct wl_client *c,
                                                   ...
                                                   struct wl_resource *s)
{
  static_cast<XBMCWayland *>(r->data)->GiveSurfaceKeyboardFocus(c, r, s);
}
...
xtw::XBMCWayland::PingSurfaceCallback(struct wl_client *c,
                                      ...
                                      uint32_t t)
{
  static_cast<XBMCWayland *>(r->data)->PingSurface(c, r, s, t);
}
...
xtwc::Compositor::Seat()
{
  ...
  if (std::string(output->model) != "headless")
    throw std::logic_error("Only the compositor-headless.so backend "
...
xtwc::Compositor::PointerResource(struct wl_client *client)
{
  ...
  return wl_resource_find_for_client(&seat->pointer->resource_list,
                                     client);
}
...
{
  struct weston_seat *seat = Seat();
  return wl_resource_find_for_client(&seat->keyboard->resource_list,
                                     client);
}
