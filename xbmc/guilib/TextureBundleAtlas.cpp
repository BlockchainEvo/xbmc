...
const CStdString CTextureBundleAtlas::FindAtlas(const CStdString& Filename)
{
  if (!m_atlasReader.IsOpen() && !OpenBundle())
    return "";
...
bool CTextureBundleAtlas::LoadSubTexture(const CStdString& Filename, CTextureArray *ppTextureArray)
{
